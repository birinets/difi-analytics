const GELATO_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint16",
        name: "rebalanceFeeBPS",
        type: "uint16",
      },
      {
        indexed: false,
        internalType: "uint16",
        name: "autoWithdrawFeeBPS",
        type: "uint16",
      },
      {
        indexed: false,
  ...
  {
    inputs: [
      { internalType: "int24", name: "_newLowerTick", type: "int24" },
      { internalType: "int24", name: "_newUpperTick", type: "int24" },
      { internalType: "uint160", name: "_swapThresholdPrice", type: "uint160" },
      { internalType: "uint256", name: "_swapAmountBPS", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "int24", name: "_lowerTick_", type: "int24" },
      { internalType: "int24", name: "_upperTick_", type: "int24" },
      { internalType: "address", name: "_owner_", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint32", name: "newObservationSeconds", type: "uint32" },
      { internalType: "uint16", name: "newMaxSlippageBPS", type: "uint16" },
      { internalType: "uint16", name: "newAdminFeeBPS", type: "uint16" },
      { internalType: "uint16", name: "newRebalanceFeeBPS", type: "uint16" },
      { internalType: "uint16", name: "newWithdrawFeeBPS", type: "uint16" },
