const MOVR_REWARDS_ABI = [
  {
    ...
    inputs: [
      ...
      { type: "uint256", name: "_rewardPerSecond", internalType: "uint256" },
      { type: "address", name: "_MASTERCHEF_V2", internalType: "address" },
    ],
  },
  { type: "event", name: "LogInit", inputs: [], anonymous: false },
  {
    type: "event",
    name: "LogOnReward",
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { type: "uint256", name: "lpToken", internalType: "uint256" },
    ],
  },
  {
    type: "function",
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: "uint256[]", name: "rewardAmounts", internalType: "uint256[]" },
    ],
    name: "pendingTokens",
    inputs: [
      { type: "uint256", name: "pid", internalType: "uint256" },
...
export default MOVR_REWARDS_ABI;
