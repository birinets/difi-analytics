const MOVR_SUSHISWAP_ABI = [
  {
    type: "constructor",
    stateMutability: "nonpayable",
    inputs: [
      { type: "address", name: "_sushi", internalType: "contract IERC20" },
    ],
  },
  {
    type: "event",
  ...
  },
  {
    ...
    stateMutability: "view",
    outputs: [
      { type: "address", name: "", internalType: "contract IMigratorChef" },
    ],
    name: "migrator",
    inputs: [],
  },
  ...
  },
  {
    ...
    stateMutability: "view",
    outputs: [
      { type: "address", name: "", internalType: "contract IRewarder" },
    ],
    name: "rewarder",
    inputs: [{ type: "uint256", name: "", internalType: "uint256" }],
  },
  ...
  },
  {
    ...
    inputs: [
      { type: "uint256", name: "_sushiPerSecond", internalType: "uint256" },
    ],
  },
  {
    type: "function",
...
export default MOVR_SUSHISWAP_ABI;
