const SADDLE_SWAP_ABI = [
  ...
  },
  {
    ...
    name: "getAllowlist",
    outputs: [
      { internalType: "contract IAllowlist", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newWithdrawFee", type: "uint256" },
    ],
...
export default SADDLE_SWAP_ABI;
