const LIXIR_TOKEN_ABI = [
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: "uint256", name: "tokensOwed1", type: "uint256" },
  ...
  },
  {
    ...
    name: "WETH_TOKEN",
    outputs: [
      { internalType: "enum ILixirVaultETH.TOKEN", name: "", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint128", name: "mL", type: "uint128" },
      { internalType: "uint128", name: "rL", type: "uint128" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "int24", name: "virtualTick", type: "int24" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "amountDesired", type: "uint256" },
    ...
    outputs: [
      { internalType: "uint256", name: "shares", type: "uint256" },
      { internalType: "uint256", name: "amountEthIn", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "int24", name: "mainTickLower", type: "int24" },
      { internalType: "int24", name: "mainTickUpper", type: "int24" },
      { internalType: "int24", name: "rangeTickLower0", type: "int24" },
      { internalType: "int24", name: "rangeTickUpper0", type: "int24" },
      { internalType: "int24", name: "rangeTickLower1", type: "int24" },
      { internalType: "int24", name: "rangeTickUpper1", type: "int24" },
  ...
  },
  {
    ...
    name: "registry",
    outputs: [
      { internalType: "contract LixirRegistry", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint24", name: "newFee", type: "uint24" }],
  ...
  },
  {
    ...
    name: "withdrawETH",
    outputs: [
      { internalType: "uint256", name: "amountEthOut", type: "uint256" },
...
export default LIXIR_TOKEN_ABI;
