const BPOOL_TOKEN_ABI = [
  {
    inputs: [
      { internalType: "address", name: "factoryAddress", type: "address" },
      {
        ...
        internalType: "structConfigurableRightsPool.PoolParams",
        name: "poolParams",
        type: "tuple",
      },
      {
        ...
        internalType: "structRightsManager.Rights",
        name: "rightsStruct",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [],
    name: "bFactory",
    outputs: [{ internalType: "contractIBFactory", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "bPool",
    outputs: [{ internalType: "contractIBPool", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      {
        internalType: "enumRightsManager.Permissions",
        name: "permission",
        type: "uint8",
      },
    ],
...
export default BPOOL_TOKEN_ABI;
